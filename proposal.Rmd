...
The following topics and questions will be investigated to further analyze the datasets:
...
2. Correlation between the factors
...
3. Extreme weather
    ...
    + What are some of the abnormal weather conditions that have recently increased due to climate change?

4. The impact of climate change

    + How does climate change affect other industries?

    + Which industry has the greatest impact on CO2 emissions?

    + Are there changes in the ecosystem or agriculture caused by changes in temperature?
